...
public class OrangeSetDataWitVersionContext extends OrangeSetDataContext {
	
	@OrangeContextFieldValue(binding = Version.class)
	private Object version;
	
	public OrangeSetDataWitVersionContext(ZNode zNode, Class<?> operationOwner, Method operationMethod, Object[] args,
