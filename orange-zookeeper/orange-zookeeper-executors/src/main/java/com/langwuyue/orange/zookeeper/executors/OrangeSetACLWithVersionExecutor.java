...
public class OrangeSetACLWithVersionExecutor extends OrangeSetACLExecutor{
	
	public OrangeSetACLWithVersionExecutor(OrangeZookeeperOperations operations) {
		super(operations);
	}

	@Override
	public Object execute(OrangeZookeeperContext context) throws Exception {
		return this.getOperations().setACL((OrangeSetACLWithVersionContext)context);
	}
	...
	public Class<? extends OrangeZookeeperContext> getContextClass() {
		return OrangeSetACLWithVersionContext.class;
	}
