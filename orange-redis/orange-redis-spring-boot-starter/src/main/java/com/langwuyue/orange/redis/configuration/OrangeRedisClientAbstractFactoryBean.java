...
public abstract class OrangeRedisClientAbstractFactoryBean implements FactoryBean<Object>, ApplicationContextAware {
	...
	protected abstract Class<? extends OrangeRedisCircuitBreaker> getCircuitBreaker​​Class();
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		this.circuitBreaker​​ = applicationContext.getBean(getCircuitBreaker​​Class());
	}
