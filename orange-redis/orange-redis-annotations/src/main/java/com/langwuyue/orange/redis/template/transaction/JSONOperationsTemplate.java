 ...
 *  public interface OrangeRedisTransactionExample1Api extends JSONOperationsTemplate{@code<Value>} {
 *  	{@code @Override}
 *  	Value getValue();
 *  }
 * </pre></blockquote>
...
public interface JSONOperationsTemplate<T> extends GlobalOperationsTemplate {
	 ...
	 * @see #setValue(Object)
	 * @param version
	 * @return a boolean value, true if the commit succeeds, false otherwise(e.g., due to a concurrent commit with a higher version).
	 */
	@Commit
