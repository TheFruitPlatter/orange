...
/**
 * Executor implementation for inserting a value to the right of a pivot element in a Redis list.
 * 
 * <p>This executor provides functionality to insert a new element to the right (after) 
 * a specified pivot element in a Redis list. If the pivot element occurs multiple times,
 * the insertion happens after the first occurrence only.
 * 
...
public class OrangePushMemberOnRightOfPivotExecutor extends OrangeRedisAbstractExecutor {
	...
	/**
	 * Constructs a new OrangePushMemberOnRightOfPivotExecutor with the specified operations and ID generator.
	 *
	...
	/**
	 * Executes the LINSERT operation to insert a value to the right of a pivot element in a Redis list.
	 * 
	 * <p>This method inserts the value specified in the context to the right (after) of the
	 ...
	 * <ul>
	 *   <li>{@link Right} - Indicates that the insertion should be to the right of the pivot</li>
	 ...
	 * both the pivot element and the value to be inserted to the right of the pivot.
	 *
