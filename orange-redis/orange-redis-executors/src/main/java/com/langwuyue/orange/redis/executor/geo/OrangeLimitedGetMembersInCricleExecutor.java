...
/**
 * Extended executor for retrieving Redis GEO members within a circle with result count limitation.
 * 
 * <p>This executor extends {@link OrangeGetMembersInCricleExecutor} to support
...
public class OrangeLimitedGetMembersInCricleExecutor extends OrangeGetMembersInCricleExecutor {
	...
	/**
	 * Constructs a new executor for limited GEO circle queries.
	 * 
