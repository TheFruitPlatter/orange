...
/**
 * Redis executor for incrementing scores by 1 in Redis Sorted Sets (ZSet).
 * 
 * <p>This executor handles the {@link Increment} annotation to increment the score
 * of a specified member in a Redis ZSet by 1. If the member doesn't exist in the ZSet,
 * it will be added with a score of 1.
 * 
...
public class OrangeIncrementExecutor extends OrangeRedisAbstractExecutor {
	...
	/**
	 * Constructs a new increment executor for Redis ZSet operations.
	 *
	 ...
	 */
	public OrangeIncrementExecutor(OrangeRedisZSetOperations operations,OrangeRedisExecutorIdGenerator idGenerator) {
		super(idGenerator);
		this.operations = operations;
	}

	/**
	 * Executes the increment operation on a Redis ZSet member.
	 * 
	 * <p>This method increments the score of the specified member in the ZSet by 1.
	 ...
	 *         return type (Double, Long, Integer, or Float), or null if the operation fails
	 ...
	 *         and member value needed for the increment operation
	 */
	@Override
