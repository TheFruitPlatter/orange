...
/**
 * Executor for performing weighted union operations on Redis Sorted Sets with aggregation.
 * 
 * <p>This executor handles the computation of weighted unions between multiple sorted sets
 * and stores the result in a destination key. The union operation returns elements
 * that exist in at least one of the specified sorted sets, with scores modified by
 ...
 */
public class OrangeUnionAndStoreByWeightsExecutor extends OrangeRedisAbstractExecutor {
	
	private OrangeRedisZSetOperations operations;

	/**
	 * Constructs a new OrangeUnionAndStoreByWeightsExecutor with the specified operations and ID generator.
	 *
	 * @param operations the Redis ZSet operations to be used for weighted union operations
	 * @param idGenerator the generator for creating unique executor IDs
	 */
	public OrangeUnionAndStoreByWeightsExecutor(OrangeRedisZSetOperations operations,OrangeRedisExecutorIdGenerator idGenerator) {
		super(idGenerator);
	 ...
	 * <p>This executor supports the following annotations:
	 * <ul>
	 *   <li>{@link Union} - Identifies methods for union operations</li>
	 *   <li>{@link CrossOperationKeys} - Specifies the keys to operate on</li>
	 *   <li>{@link StoreTo} - Specifies the destination key</li>
	...
	protected List<Class<? extends Annotation>> getSupportedAnnotationClasses() {
		return OrangeCollectionUtils.asList(Union.class,CrossOperationKeys.class,StoreTo.class,Aggregate.class,Weights.class);
	}

	/**
	 * Executes the weighted union operation with aggregation and stores the result.
	 * 
	 * <p>This method performs a weighted union between the reference key and comparison keys,
