...
/**
 * Executor implementation for popping multiple elements from the left side of a Redis list.
 * 
 * <p>This executor extends {@link OrangeRedisGetAbstractExecutor} to provide
 * functionality for removing and returning multiple elements from the beginning (left side)
 * of a Redis list. It supports the {@link PopMembers}, {@link Count}, and {@link Left} annotations
 * to indicate that multiple elements should be popped from the left side of the list.
 * 
 * <p>The executor removes and returns elements from the list in a FIFO
 * (First-In-First-Out) manner, where the first elements added to the list will
 * be the first ones removed. The number of elements to pop is specified by the
 ...
 */
public class OrangeLeftPopMembersExecutor extends OrangeRedisGetAbstractExecutor {
	...
	/**
	 * Constructs a new OrangeLeftPopMembersExecutor.
	 *
	 ...
	 */
	public OrangeLeftPopMembersExecutor(OrangeRedisListOperations operations,OrangeRedisExecutorIdGenerator idGenerator) {
		super(idGenerator);
	 ...
	 * </ul>
	 *
	 * @return a list containing the PopMembers, Count, and Left annotation classes
	 */
	@Override
	protected List<Class<? extends Annotation>> getSupportedAnnotationClasses() {
		return OrangeCollectionUtils.asList(PopMembers.class,Count.class,Left.class);
	}
	
	/**
	 * Returns the context class used by this executor.
	 * 
	 * <p>This executor uses {@link OrangeRedisCountContext} to handle the count parameter
	 * specified by the {@link Count} annotation, which determines how many elements
	 * should be popped from the list.
	 *
	...
	/**
	 * Performs the left pop operation on a Redis list for multiple elements.
	 * 
	 * <p>This method removes and returns multiple elements from the beginning (left side)
	 * of the Redis list identified by the key in the provided context. The number of
	 * elements to pop is determined by the count value in the {@link OrangeRedisCountContext}.
	 *
