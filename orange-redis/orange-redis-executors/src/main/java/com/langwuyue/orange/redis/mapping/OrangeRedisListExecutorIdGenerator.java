...
public class OrangeRedisListExecutorIdGenerator extends OrangeRedisExecutorIdAbstractGenerator {
	...
	protected void registerSupportedAnnotationClasses(List<Class<? extends Annotation>> supportedAnnotationClasses) {
		...
		supportedAnnotationClasses.add(Index.class);
		supportedAnnotationClasses.add(Left.class);
		supportedAnnotationClasses.add(Right.class);
		supportedAnnotationClasses.add(Reverse.class);
		supportedAnnotationClasses.add(Pivot.class);
