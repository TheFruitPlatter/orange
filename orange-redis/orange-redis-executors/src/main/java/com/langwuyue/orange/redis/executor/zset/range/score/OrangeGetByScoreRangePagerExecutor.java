 ...
 * using a score range.
 * 
 * <p>This executor extends the functionality of {@link OrangeGetByScoreRangeExecutor} by adding
 * pagination support. It allows clients to retrieve a subset of members within a specified score
 * range using offset and count parameters. It supports the following annotations:
 * <ul>
 ...
 * </ul>
 * 
 * <p>The executor uses {@link OrangeRedisZSetOperations#rangeByScore} with pagination parameters
 * to perform the actual Redis operation. It retrieves a subset of members whose scores are within 
 * the specified range, starting from the given offset and returning up to count members.
 * 
 * @author Liang.Zhong
 * @since 1.0.0
 ...
 */
public class OrangeGetByScoreRangePagerExecutor extends OrangeRedisGetAbstractExecutor {
	
	/**
	 * Redis ZSet operations instance used to execute the actual Redis commands.
	 * This provides access to specialized sorted set operations including rangeByScore with pagination.
	 */
	private OrangeRedisZSetOperations operations;

	/**
	 * Constructs a new executor for retrieving paginated ZSet members using a score range.
	 * 
	 ...
	 */
	public OrangeGetByScoreRangePagerExecutor(OrangeRedisZSetOperations operations,OrangeRedisExecutorIdGenerator idGenerator) {
		super(idGenerator);
		this.operations = operations;
	}

	/**
	 * Retrieves a paginated subset of members from the Redis ZSet within the specified score range.
	 * 
	 ...
	 *   <li>Executes the rangeByScore operation with pagination parameters to get a subset of members
	 * </ol>
	 * 
	 ...
	 * @return A Collection of members within the specified score range, limited by pagination parameters
	 ...
	 * retrieve a paginated subset of members within a specified score range. The Pager annotation
	...
	protected List<Class<? extends Annotation>> getSupportedAnnotationClasses() {
		return OrangeCollectionUtils.asList(GetMembers.class,ScoreRange.class,Pager.class);
	}
	 ...
	 * allowing this executor to retrieve a subset of members within the specified score range.
	 * 
