...
/**
 * Executor implementation for pushing a single element to the right side of a Redis list.
 * 
 * <p>This executor extends {@link OrangeRedisAbstractExecutor} to provide
 * functionality for adding a single element to the end (right side)
 * of a Redis list. It supports the {@link Right}, {@link AddMembers}, and {@link RedisValue}
 * annotations to indicate that an element should be pushed to the right side of the list.
 * 
 * <p>The executor adds elements to the list in a FIFO (First-In-First-Out) manner,
 * where new elements are added to the end of the list. The operation returns
 ...
 */
public class OrangeRightPushMemberExecutor extends OrangeRedisAbstractExecutor {
	...
	/**
	 * Constructs a new OrangeRightPushMemberExecutor with the specified operations and ID generator.
	 *
	 ...
	 */
	public OrangeRightPushMemberExecutor(OrangeRedisListOperations operations,OrangeRedisExecutorIdGenerator idGenerator) {
		super(idGenerator);
		this.operations = operations;
	}

	/**
	 * Executes the right push operation by adding a single element to the right side of the Redis list.
	 * 
	...
	public Object execute(OrangeRedisContext context) throws Exception {
		...
		Long result = this.operations.rightPush(context.getRedisKey().getValue(), ctx.getValueType(), ctx.getValue());
	...
	protected List<Class<? extends Annotation>> getSupportedAnnotationClasses() {
		return OrangeCollectionUtils.asList(Right.class,AddMembers.class,RedisValue.class);
	}
