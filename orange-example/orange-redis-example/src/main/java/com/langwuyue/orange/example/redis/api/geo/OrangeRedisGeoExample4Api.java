 ...
 * @since 1.0.0
 */
@OrangeRedisKey(expirationTime = @Timeout(value = 1, unit = TimeUnit.HOURS), key = "orange:geo:example4")
public interface OrangeRedisGeoExample4Api extends JSONOperationsTemplate<OrangeGeoExampleEntity,OrangeValueExampleEntity> {
