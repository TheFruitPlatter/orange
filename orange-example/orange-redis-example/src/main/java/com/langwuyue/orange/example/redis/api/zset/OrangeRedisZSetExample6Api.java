 ...
 * @since 1.0.0
 */
@OrangeRedisKey(expirationTime = @Timeout(value = 1, unit = TimeUnit.HOURS), key = "orange:zset:example6")
public interface OrangeRedisZSetExample6Api extends JSONOperationsTemplate<ZSetValue> {
