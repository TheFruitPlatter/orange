 ...
 */
@RestController
public class OrangeRedisLockSimpleTestCases {
	
	@Autowired
	private OrangeRedisValueExample6Api valueExample6Api;
	
	@PutMapping("/v1/valueOperations/locks")
	public OrangeRedisExampleResponse testCase() {
		try {
			valueExample6Api.lock();
