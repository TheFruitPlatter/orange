...
public class OrangeHashAddMembersIfAbsentListener implements OrangeRedisHashAddMembersIfAbsentListener {

	@Override
	public void onCompleted(OrangeAddMembersIfAbsentEvent event) {
		System.out.println("OrangeHashAddMembersIfAbsentListener receive completed event");
	}
