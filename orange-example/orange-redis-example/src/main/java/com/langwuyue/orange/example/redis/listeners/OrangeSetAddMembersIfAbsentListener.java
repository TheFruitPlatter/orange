...
public class OrangeSetAddMembersIfAbsentListener implements OrangeRedisSetAddMembersIfAbsentListener {

	@Override
	public void onCompleted(OrangeAddMembersIfAbsentEvent event) {
		System.out.println("OrangeSetAddMembersIfAbsentListener receive completed event");
	}
