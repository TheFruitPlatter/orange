...
import com.langwuyue.orange.example.redis.api.value.OrangeRedisValueExample1Api;
...
public class OrangeRedisJSONSimpleTestCases {
	...
	@Autowired
	private OrangeRedisValueExample1Api valueExample1Api;
	
	@PutMapping("/v1/valueOperations/values")
	public OrangeRedisExampleResponse testCase1(@RequestBody OrangeValueExampleEntity entity) {
		try {
			valueExample1Api.setValue(entity);
	...
	@PutMapping("/v1/valueOperations/concurrentValues")
	public OrangeRedisExampleResponse testCase2(@RequestBody OrangeCompareAndSwapEntity entity) {
		try {
			return new OrangeRedisExampleResponse(valueExample1Api.compareAndSwap(entity.getOldValue(),entity.getNewValue()));
		}catch (Exception e) {
			e.printStackTrace();
	...
	@GetMapping("/v1/valueOperations/values")
	public OrangeRedisExampleResponse testCase3() {
		try {
			Object value = valueExample1Api.getValue();
	...
	@DeleteMapping("/v1/valueOperations/deletedValues")
	public OrangeRedisExampleResponse testCase4() {
		try {
			boolean success = valueExample1Api.delete();
			if(success) {
				return new OrangeRedisExampleResponse();
			}
	...
	@GetMapping("/v1/valueOperations/expirations")
	public OrangeRedisExampleResponse testCase6() {
		try {
			return new OrangeRedisExampleResponse(valueExample1Api.getExpiration(TimeUnit.SECONDS));
		}catch (Exception e) {
			e.printStackTrace();
	...
	@PutMapping("/v1/valueOperations/expirations")
	public OrangeRedisExampleResponse testCase7() {
		try {
			valueExample1Api.setExpiration();
			return new OrangeRedisExampleResponse();
		}catch (Exception e) {
			e.printStackTrace();
