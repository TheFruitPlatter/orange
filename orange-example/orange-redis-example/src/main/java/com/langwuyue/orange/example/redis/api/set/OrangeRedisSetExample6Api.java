 ...
 * @since 1.0.0
 */
@OrangeRedisKey(expirationTime = @Timeout(value = 1, unit = TimeUnit.HOURS), key = "orange:set:example6")
public interface OrangeRedisSetExample6Api extends JSONOperationsTemplate<OrangeValueExampleEntity> {
