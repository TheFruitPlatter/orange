 ...
 * @since 1.0.0
 */
@OrangeRedisKey(expirationTime = @Timeout(value = 1, unit = TimeUnit.HOURS), key = "orange:zset:example8")
public interface OrangeRedisZSetExample8Api extends JSONOperationsTemplate<ZSetValue> {
