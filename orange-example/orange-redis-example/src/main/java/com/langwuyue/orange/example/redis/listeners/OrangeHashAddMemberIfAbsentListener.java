 ...
 */
@Component
@OrangeRedisIfAbsentListener(keys = {OrangeRedisHashExample1Api.class})
public class OrangeHashAddMemberIfAbsentListener implements OrangeRedisHashAddMemberIfAbsentListener {

	@Override
	public void onFailure(OrangeAddMemberIfAbsentFailedEvent event) {
		System.out.println("OrangeHashAddMemberIfAbsentListener receive failed event");
		
	}

	@Override
	public void onSuccess(OrangeAddMemberIfAbsentSuccessEvent event) {
		System.out.println("OrangeHashAddMemberIfAbsentListener receive success event");
